...
SSL_COMMERZ_SANDBOX = config('SSL_COMMERZ_SANDBOX', default=False, cast=bool)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@styleghor.com')
